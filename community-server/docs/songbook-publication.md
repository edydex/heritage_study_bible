...
In **Song library**, open a song and choose **Songbook publication**, then **Save**:
...
To change several songs, select their rows, choose **Edit → Songbook publication**, select the desired setting and save. Publishing is a church decision; adding rights/source notes is optional. It does not upload files or private notes.
