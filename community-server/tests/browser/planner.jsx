...
createRoot(document.getElementById('root')).render(<div className="heritage-planner-frame">{location.search.includes("workspace") ? <PrepareSermonClient /> : <PlanServiceClient sermonSyncId="canvas-rehearsal" />}</div>)
