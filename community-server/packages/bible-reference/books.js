// Bible book metadata - chapters per book
...
export const getBookByName = (name) => bibleBooks.find(b => b.name === name)
export const getBookByAbbr = (abbr) => bibleBooks.find(b => b.abbr === abbr)
export const getOldTestament = () => bibleBooks.filter(b => b.testament === 'OT')
export const getNewTestament = () => bibleBooks.filter(b => b.testament === 'NT')
