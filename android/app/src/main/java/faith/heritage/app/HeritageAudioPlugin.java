...
public class HeritageAudioPlugin extends Plugin {
    ...
    private final Player.Listener events = new Player.Listener() {
        @Override public void onEvents(Player player, Player.Events events) { if (foreground) requestState(); }
    };
    ...
    @Override protected void handleOnResume() {
        foreground = true;
        handler.post(() -> { if (controller != null) requestState(); handler.removeCallbacks(tick); handler.post(tick); });
    }
